...
filenames = os.listdir("C:/Users/eds12/OneDrive/Рабочий стол/питон папка/ai_try2/tmp/train/train")
...
image = load_img("C:/Users/eds12/OneDrive/Рабочий стол/питон папка/ai_try2/tmp/train/train/" + sample)
plt.imshow(image)
...
train_generator = train_datagen.flow_from_dataframe(
    train_df,
    "C:/Users/eds12/OneDrive/Рабочий стол/питон папка/ai_try2/tmp/train/train/",
    x_col='filename',
    y_col='category',
...
test_filenames = os.listdir("C:/Users/eds12/OneDrive/Рабочий стол/питон папка/ai_try2/tmp/train/test1/")
...
test_generator = test_gen.flow_from_dataframe(
    test_df,
    "C:/Users/eds12/OneDrive/Рабочий стол/питон папка/ai_try2/tmp/train/test1/",
    x_col='filename',
    y_col=None,
    class_mode=None,
    target_size=IMAGE_SIZE,
...
for index, row in sample_test.iterrows():
    ...
    img = load_img("C:/Users/eds12/OneDrive/Рабочий стол/питон папка/ai_try2/tmp/train/test1/"+filename, target_size=IMAGE_SIZE)
